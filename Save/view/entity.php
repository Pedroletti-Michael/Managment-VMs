...
?>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Table entity - HEIG-VD</title>
    </head>
    <body>
    <div class="pr-3 pt-3">
        <h3 class="text-center border border-danger border-left-0 border-right-0 border-top-0 pb-3">Base de données - Table - entity</h3>
