    ...
    <form method="post" action="../index.php?action=RequestVM" class="mb-4">
        <div class="d-inline-block w-100">
            ...
            <div class="form-group w-50 float-left pr-4" id="responsiveDisplay">
                ...
                <input type="vmName" class="form-control form form text-uppercase" id="inputVMName" name="inputVMName" aria-describedby="vmNameHelp" maxlength="15" placeholder="Exemple : DPT-VM01" required onkeyup="checkName()">
