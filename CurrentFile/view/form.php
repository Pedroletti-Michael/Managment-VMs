    ...
    <form method="post" action="RequestVM" class="mb-4">
        <div class="d-inline-block w-100">
            ...
            <div class="form-group w-50 float-left pr-4">
                ...
                <input type="vmName" class="form-control form form" id="inputVMName" aria-describedby="vmNameHelp" maxlength="12">
                <small id="vmNameHelp" class="form-text text-muted">12 caractères maximum. Lettres, chiffres et trait d'union uniquement (Ex: VM-01)</small>
            </div>
            <!--Name of the requester-->
            <div class="form-group w-50 float-right pl-4">
                <label for="inputResquesterName" class="font-weight-bold">Demandeur</label>
                <input type="requesterName" class="form-control form form" id="inputResquesterName" aria-describedby="requesterNameHelp" placeholder="Entrer un nom ou une addresse de messagerie" maxlength="12">
            </div>
        </div>
        <div class="d-inline-block w-100">
            <div class="form-group w-50 float-left pr-4">
            ...
            <div class="form-group w-50 float-right pl-4">
                ...
                <input type="tmName" class="form-control form form" id="inputTMName" aria-describedby="tmNameHelp" placeholder="Entrer un nom ou une addresse de messagerie" maxlength="12">
            </div>
        </div>
        <div class="d-inline-block w-100">
            <div class="form-group w-50 float-left pr-4">
            ...
            <div class="form-group w-50 float-right pl-4">
                ...
                <input type="raName" class="form-control form form" id="inputRAName" aria-describedby="raNameHelp" placeholder="Entrer un nom ou une addresse de messagerie" maxlength="12">
        ...
        <div class="d-inline-block w-100">
            ...
            <div class="form-group w-50 float-right pl-4">
                ...
                <select class="form-control" id="disFormControlSelect">
                    <option>S-ISI</option>
                    <option>SIPA</option>
                    <option>COMEM+</option>
                    <option>EC+G</option>
        ...
        <div class="d-inline-block w-100">
            ...
            <div class="form-group w-50 float-left pr-4">
                ...
                <select class="form-control" id="osFormControlSelect">
            ...
            <div class="form-group w-50 float-right pl-4">
                ...
                <input type="date" class="form-control form form" id="inputComissioningDate" aria-describedby="comissioningDateHelp" placeholder="Entrer un nom ou une addresse de messagerie" maxlength="12">
        ...
        <div class="d-inline-block w-100">
            ...
            <div class="form-group w-50 float-left pr-4">
                ...
                <select class="form-control" id="networkFormControlSelect">
                    <option>LAN</option>
                    <option>DMZ</option>
            ...
            <div class="form-group w-50 float-right pl-4">
                ...
                <input type="date" class="form-control form form" id="inputEndDate" aria-describedby="EndDateHelp" placeholder="Entrer un nom ou une addresse de messagerie" maxlength="12">
        ...
        <div class="form-group">
            <label for="usingFormControlSelect" class="font-weight-bold">Département / Institution / Service</label>
            <select class="form-control" id="usingFormControlSelect">
                <option>R&D</option>
                <option>Académique</option>
                <option>R&D et académique</option>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" rows="5" id="objective"></textarea>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="snapshotsFormControlSelect">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="backupFormControlSelect">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="securityFormControlSelect">
